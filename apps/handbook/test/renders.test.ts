...
const BOUNDARY = readFileSync(join(HANDBOOK, 'src/ui/Boundary.tsx'), 'utf8');
const APP = readFileSync(join(HANDBOOK, 'src/App.tsx'), 'utf8');
const RENDERS = readFileSync(join(HANDBOOK, 'scripts/renders.mjs'), 'utf8');
 ...
 * mounted calls that a rendered handbook and goes green, which is the failure the
