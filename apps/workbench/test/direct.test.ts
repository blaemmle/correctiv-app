...
/**
 * What the workbench draws itself, held against what the app actually has.
 *
 ...
 */
describe('the components the workbench draws', () => {
  /**
...
describe('the components overview', () => {
  ...
  it('asks the two boxes which cards clip rather than naming the components', () => {
    ...
    const clipped = readFileSync(join(WORKBENCH, 'src/components/clipped.ts'), 'utf8');
