...
Thirty-five records shaped this repo. Read them when you want to know *why* something
...
`apps/handbook/plugin/markdown.ts` mints that id from the figure rather than from a
