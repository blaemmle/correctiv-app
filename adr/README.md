...
| [0042](0042-the-timeline-belongs-to-the-stage.md) | The timeline belongs to the stage, not the tools | accepted, **not built**; four decisions, moves 0039 §10's track out of the tool panel, strikes nothing and says which sentence the carrying-out will strike, two open items named |
